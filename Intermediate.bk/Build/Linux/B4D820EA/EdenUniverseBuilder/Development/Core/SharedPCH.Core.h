// PCH for /opt/unreal-engine/Engine/Source/Runtime/Core/Public/CoreSharedPCH.h
#define IS_PROGRAM 0
#define UE_GAME 1
...
#define WITH_MALLOC_STOMP 1
#define CORE_API 
#include "/opt/unreal-engine/Engine/Source/Runtime/Core/Public/CoreSharedPCH.h"
