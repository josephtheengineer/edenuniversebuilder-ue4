...
EdenUniverseBuilderRootPath=/home/josephtheengineer/workspace/edenproject/EdenUniverseBuilder

gameProjectFile=/home/josephtheengineer/workspace/edenproject/EdenUniverseBuilder/EdenUniverseBuilder.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(EdenUniverseBuilderSource.pri)
include(EdenUniverseBuilderHeader.pri)
include(EdenUniverseBuilderConfig.pri)
include(EdenUniverseBuilderIncludes.pri)
include(EdenUniverseBuilderDefines.pri)

EdenUniverseBuilder-Linux-Debug.commands = $$build EdenUniverseBuilder Linux Debug  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilder-Linux-DebugGame.commands = $$build EdenUniverseBuilder Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilder-Linux-Shipping.commands = $$build EdenUniverseBuilder Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilder-Linux-Test.commands = $$build EdenUniverseBuilder Linux Test  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilder.commands = $$build EdenUniverseBuilder Linux Development  -project="\"$$gameProjectFile\"" $$args

EdenUniverseBuilderEditor-Linux-Debug.commands = $$build EdenUniverseBuilderEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilderEditor-Linux-DebugGame.commands = $$build EdenUniverseBuilderEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilderEditor-Linux-Shipping.commands = $$build EdenUniverseBuilderEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilderEditor-Linux-Test.commands = $$build EdenUniverseBuilderEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
EdenUniverseBuilderEditor.commands = $$build EdenUniverseBuilderEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	EdenUniverseBuilder-Linux-Debug \
	EdenUniverseBuilder-Linux-DebugGame \
	EdenUniverseBuilder-Linux-Shipping \
	EdenUniverseBuilder-Linux-Test \
	EdenUniverseBuilder \
	EdenUniverseBuilderEditor-Linux-Debug \
	EdenUniverseBuilderEditor-Linux-DebugGame \
	EdenUniverseBuilderEditor-Linux-Shipping \
	EdenUniverseBuilderEditor-Linux-Test \
	EdenUniverseBuilderEditor \
