...
void AEdenUniverseBuilderCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	InputComponent->BindAction("Raycast", IE_Pressed, this, &AEdenUniverseBuilderCharacter::PerformRaycast);
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AEdenUniverseBuilderProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AEdenUniverseBuilderProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AEdenUniverseBuilderCharacter::PerformRaycast()
{
