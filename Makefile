...
EdenUniverseBuilder-Linux-Debug:
	 $(PROJECTBUILD) EdenUniverseBuilder Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilder-Linux-DebugGame:
	 $(PROJECTBUILD) EdenUniverseBuilder Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilder-Linux-Shipping:
	 $(PROJECTBUILD) EdenUniverseBuilder Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilder-Linux-Test:
	 $(PROJECTBUILD) EdenUniverseBuilder Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilder:
	 $(PROJECTBUILD) EdenUniverseBuilder Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilderEditor-Linux-Debug:
	 $(PROJECTBUILD) EdenUniverseBuilderEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilderEditor-Linux-DebugGame:
	 $(PROJECTBUILD) EdenUniverseBuilderEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilderEditor-Linux-Shipping:
	 $(PROJECTBUILD) EdenUniverseBuilderEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilderEditor-Linux-Test:
	 $(PROJECTBUILD) EdenUniverseBuilderEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

EdenUniverseBuilderEditor:
	 $(PROJECTBUILD) EdenUniverseBuilderEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
